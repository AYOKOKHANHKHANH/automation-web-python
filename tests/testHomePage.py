...
import pytest
import unittest
from manages.driverManages import get_driver
...
class TestHomePage(unittest.TestCase):
    ...
    def test_blog_button(self):
        self.landing.blog_btn.is_existing()
        self.landing.blog_btn.is_enable()
        self.assertTrue(self.landing.blog_btn.text()=='Blog')
        print('Click Blog button')
        self.landing.blog_btn.click()
        self.driver.switch_to.window(self.driver.window_handles[1])
        self.assertTrue(self.driver.current_url == UrlData.blog_page_url())
